...
See a live preview [here](https://rubyhill-jeopardy.netlify.app/)
...
- [x] improve responsiveness of the layout for smaller screen sizes: done
- [ ] improve responsiveness for ultra-large screen sizes
...
- [x] add a front-end setup interface to allow users to add their own clues and questions: done
